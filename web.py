...
def main():
    ...
    st.sidebar.image("https://img.freepik.com/free-vector/heart-medical-health-care-logo_1017-10118.jpg", width=200) 
    ...
    with col3:
        st.subheader("基本信息")
        # 年龄（数值）
        age = st.number_input("年龄（岁）", value=60, step=1, min_value=18, max_value=120, key='age')
        # 心率（数值）
    ...
    if predict_button:
        ...
        if model_feature_names:
            # 假设 feature_names_display 与模型特征名严格一致
    ...
    # 版权或说明
    st.write("---")
    st.caption("© 2025 基于机器学习的早发心梗后心衰中西医结合预测模型. 保留所有权利。")
